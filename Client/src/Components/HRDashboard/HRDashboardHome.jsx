            ...
            <div>
              {quickActions.map((action) => (
                ...
                >
                  ...
                  <span className="flex-grow-1">{action.name}</span>
                  <span>→</span>
                </Link>
              ))}
            </div>
                    ...
                    recentCandidates.map((candidate) => (
                      <div key={candidate.id} className="hr-candidate-card mb-2">
                        <div className="d-flex align-items-center">
                          <div className="hr-user-avatar rounded-circle d-flex align-items-center justify-content-center text-white fw-bold me-3 flex-shrink-0" style={{width: '40px', height: '40px', fontSize: '0.875rem', background: 'linear-gradient(135deg, #3b82f6 0%, #2563eb 100%)'}}>
                          ...
                          <span className={`badge ${getStageColor(candidate.currentStage)} flex-shrink-0 ms-2`} style={{fontSize: '0.65rem'}}>
                  ...
                  {upcomingInterviews.length > 0 ? (
                    upcomingInterviews.map((interview) => (
                      <div key={interview.id} className="hr-candidate-card mb-2">
                        <div className="d-flex align-items-center">
                          <div className="hr-user-avatar rounded-circle d-flex align-items-center justify-content-center text-white fw-bold me-3 flex-shrink-0" style={{width: '40px', height: '40px', fontSize: '0.875rem', background: 'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)'}}>
